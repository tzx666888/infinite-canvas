...
产品图必填。达人出镜时，人物图与产品图必须为两个独立节点。没有真实证据时，不得使用评价、销量、稀缺库存、折扣、治疗效果或前后对比。
...
- 0–2 秒：Hook，产品立即可见或在 1 秒内进入画面。
- 2–10 秒：一次真实演示或体验，最多两个连续动作。
- 10–13 秒：产品细节或可信结果，只展示可观察内容。
- 13–15 秒：稳定 hero shot 与柔和 CTA。
...
最终完整 prompt 保持 90–170 个英文词。不得写 Markdown、复杂时间表、data URL、base64、未上传素材或模型不支持的参数。

### 6. 确认与执行边界

先向用户展示：Product Truth Sheet、获胜 Hook、中文创意摘要、15 秒结构、完整英文 H3 prompt、印尼语口播、两条 A/B Hook 变体。
...
任务状态为成功不等于成片合格。必须观看完整视频并听完整音频，按 `qc-scorecard.md` 打分。
...
2. 3 个 Hook 与评分
3. 获胜创意摘要
4. 0–2 / 2–10 / 10–13 / 13–15 秒镜头结构
5. 可直接用于当前 H3 能力的英文 prompt
6. 印尼语口播及词数
7. 两条 A/B Hook 变体
8. 风险与生成前确认项
