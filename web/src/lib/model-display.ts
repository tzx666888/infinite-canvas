...
export function modelDisplayInfo(model: string): ModelDisplayInfo {
    ...
    if (lower === "qy-seedance-2.0") return { label: "Seedance 2.0", description: "图/视频/音频多参考；5–15 秒；最高 1080p；支持声音", badge: "Seedance" };
    if (lower === "qy-seedance-2.0-fast") return { label: "Seedance 2.0 Fast", description: "图/视频/音频多参考；5–15 秒；最高 720p；支持声音", badge: "Seedance" };
