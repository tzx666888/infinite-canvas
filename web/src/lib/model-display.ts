...
export function modelDisplayInfo(model: string): ModelDisplayInfo {
    ...
    if (lower === "veo_3_1_t2v_fast_landscape") return { label: "Veo 3.1 文生视频 · 横屏", description: "纯文字生成；4、6、15 秒；720p", badge: "Google" };
    if (lower === "veo_3_1_t2v_fast_portrait") return { label: "Veo 3.1 文生视频 · 竖屏", description: "纯文字生成；4、6、15 秒；720p", badge: "Google" };
    if (lower === "veo_3_1_i2v_s_fast_fl") return { label: "Veo 3.1 首尾帧 · 横屏", description: "1–2 张参考图；4、6、15 秒；720p", badge: "Google" };
    if (lower === "veo_3_1_i2v_s_fast_portrait_fl") return { label: "Veo 3.1 首尾帧 · 竖屏", description: "1–2 张参考图；4、6、15 秒；720p", badge: "Google" };
