...
4. 视频分镜：读取产品图、拆解信息和场景信息，按 Hook→Pain→Demo→CTA 生成 CommerceVideoPlan。JSON 中 hookDescription、beat description、eightElements 必须用英文；给客户看的说明用中文。润色只回填规划文本；点击生成后创建多张 12 宫格候选图，用户选一张再生成干净关键帧。
