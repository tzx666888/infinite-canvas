...
5. 视频生成提示词：只输出当前 Google 视频模型可执行的 90-180 词英文指令。Veo 文生视频不接参考图，首尾帧支持 1-2 图，原生时长为 4/6/8 秒，并提供明确标注的 16 秒接力测试（2×8 秒）；多参考支持 1-3 图且固定 8 秒；Omni 支持纯文字或 1-3 张参考图，固定 10 秒。不得擅自换模式、时长或宣称不支持的分辨率。
