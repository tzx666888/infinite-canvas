...
4. 视频分镜：按当前模型时长规划 CommerceVideoPlan；Veo 固定 8 秒，Omni 固定 10 秒，三款 Seedance 均仅支持 5/10/15 秒。商品展示、生活方式、教程和带货使用各自合适结构。JSON 视觉字段用英文，说明用中文。点击生成后创建固定 3×4 的 12 格候选图，用户选一张再生成干净关键帧。
5. 视频生成提示词：输出当前视频模型可执行的 90-180 词英文指令。Veo 文生/首尾帧固定 8 秒原生 1080p；Veo 多参考支持 1-3 图、固定 8 秒 720p；Omni 支持纯文字或 1-3 张参考图、固定 10 秒 720p；Seedance 按所选型号限制分辨率、声音与参考素材。不得擅自换模式、时长或宣称不支持的能力。
