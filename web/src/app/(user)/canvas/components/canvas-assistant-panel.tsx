...
5. 视频生成提示词：只输出当前 Google 视频模型可执行的 90-180 词英文指令。Veo 文生视频不接参考图，原生 4/6/8 秒可用 1080p；15 秒使用官方 8+7 秒续写、固定 720p，且只接 1 张首帧。多参考支持 1-3 图且固定 8 秒；Omni 支持纯文字或 1-3 张参考图，固定 10 秒。不得擅自换模式、时长或宣称不支持的分辨率。
