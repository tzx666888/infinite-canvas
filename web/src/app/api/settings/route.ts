...
const FALLBACK_MODELS = ["gpt-image-2", ...TOKAXIS_GPT_IMAGE_2_5_MODEL_IDS, ...ACTIVE_GOOGLE_VIDEO_MODEL_IDS, ...TOKAXIS_MINIMAX_H3_VIDEO_MODEL_IDS, ...TOKAXIS_VIDEO30_MODEL_IDS, ...PRODUCT_VIDEO_MODEL_IDS, "gpt-5.6-sol", "gpt-5.5", "gpt-5.4", "gpt-5.4-mini", "gpt-4o-mini-tts", "tts-1"];
