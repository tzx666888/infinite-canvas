...
assert.match(mixedCleanerPrompt, /I'm ready to enjoy more time in the water/i);
...
assert.match(mixedCleanerPrompt, /Continue location ambience and low music after the line/i);
