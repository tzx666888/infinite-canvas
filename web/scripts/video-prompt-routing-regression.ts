...
assert.match(shortIndonesiaTenSecondCompiled, /0\.00-1\.20s/);
assert.match(shortIndonesiaTenSecondCompiled, /1\.20-2\.00s/);
assert.match(shortIndonesiaTenSecondCompiled, /rear shoe is already sliding about one short step forward/);
assert.match(shortIndonesiaTenSecondCompiled, /Keep both feet visible/);
assert.match(shortIndonesiaTenSecondCompiled, /no floating, jumping, kneeling, sitting, teleporting, instant pose reset, cartoon timing, exaggerated acting, or staged smile/);
assert.match(shortIndonesiaTenSecondCompiled, /brief involuntary breath and restrained glance/);
assert.match(shortIndonesiaTenSecondCompiled, /one motivated fast whip-pan/);
assert.match(shortIndonesiaTenSecondCompiled, /do not cut away and back, do not show the product yet/);
...
assert.match(shortIndonesiaTenSecondCompiled, /Never show or flash the product before 2s/);
assert.match(shortIndonesiaTenSecondCompiled, /never cut away and back during the incident/);
assert.match(shortIndonesiaTenSecondCompiled, /never begin the product demonstration early, finish the hook early, or hold a static frame before 2s/);
...
assert.match(shortIndonesiaTenSecondCompiled, /Eh, hampir jatuh\. Oke, lanjut—lihat yang ini\./);
...
assert.match(shortIndonesiaFifteenSecondCompiled, /0\.00-1\.80s/);
assert.match(shortIndonesiaFifteenSecondCompiled, /1\.80-3\.00s/);
assert.match(shortIndonesiaFifteenSecondCompiled, /At exactly 3\.00s, after the complete hook payoff/);
assert.match(shortIndonesiaFifteenSecondCompiled, /brief involuntary breath and restrained glance/);
assert.match(shortIndonesiaFifteenSecondCompiled, /one motivated fast whip-pan/);
...
assert.match(shortIndonesiaFifteenSecondCompiled, /Eh, hampir jatuh\. Oke, lanjut—lihat yang satu ini\./);
